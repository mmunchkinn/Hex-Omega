...
urlpatterns = [
    ...
    url(r"^admin_user/(?P<username>[A-Z0-9][0-9]{7})/update_user/(?P<user>[A-Z0-9][0-9]{7})/$", cv.user_update, name='update_user'),
    url(r"^admin_user/(?P<username>[A-Z0-9][0-9]{7})/user_detail/(?P<user>[A-Z0-9][0-9]{7})/$", cv.get_user_detail, name='user_detail'),
    url(r"^admin_user/(?P<username>[A-Z0-9][0-9]{7})/delete/(?P<d>[A-Z0-9][0-9]{7})/$", cv.delete_a_user, name='delete_user'),
