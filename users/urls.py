...
urlpatterns = [
    ...
    url(r'^admin_user/(?P<username>[a-zA-Z0-9_]{7,10})/$', views.logged_in, name="admin_user_logged_in"),
    # show, create and edit tasks for specific project
    url(r'^leader_user/(?P<username>[a-zA-Z0-9_]{7,10})/$', views.logged_in, name="leader_user_logged_in"),
    # Show tasks assigned to specific user and able to upload deliverable.
    url(r'^member_user/(?P<username>[a-zA-Z0-9_]{7,10})/$', views.logged_in, name="member_user_logged_in"),
    # ----- Claudia
