# -*- coding: utf-8 -*-
# Generated by Django 1.10.5 on 2017-02-26 06:54
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('content', models.TextField(blank=True, null=True, verbose_name=100)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[(0, 'Open'), (1, 'Closed')], default=0, max_length=7)),
                ('start_date', models.DateTimeField(blank=True)),
                ('end_date', models.DateTimeField(blank=True)),
                ('description', models.TextField(blank=True, max_length=500)),
                ('action_list', models.OneToOneField(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='users.ActionList')),
                ('activity_log', models.OneToOneField(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='users.ActivityLog')),
            ],
            options={
                'db_table': 'Project',
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('status', models.CharField(choices=[(0, 'Draft'), (1, 'Final'), (2, 'Unassigned'), (3, 'Assigned'), (4, 'Completed'), (5, 'Late'), (6, 'Not Submitted')], default=2, max_length=14)),
